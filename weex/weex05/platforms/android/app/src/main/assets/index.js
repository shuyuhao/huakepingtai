...
var _Weextext = __webpack_require__(265);

var _Weextext2 = _interopRequireDefault(_Weextext);

var _Notice = __webpack_require__(278);
...
var _Homepage_middle = __webpack_require__(22);

var _Homepage_middle2 = _interopRequireDefault(_Homepage_middle);

var _Homepage_header = __webpack_require__(254);
...
exports.default = {
  components: { 'homepagemiddle': _Homepage_middle2.default, 'homepageheader': _Homepage_header2.default }
};
...
__vue_options__.__file = "E:\\weexproject\\weex05\\src\\components\\Homepage_middle.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-6f641826"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _vueevent = __webpack_require__(15);
...
exports.default = {
  ...
  methods: {
    fetch: function fetch(event) {
      ...
      setTimeout(function () {
        var length = _this.newsList.length;
        for (var i = length; i < length + 4; i++) {
          var a = i + 1;
          _this.newsList.push({ title: 'news' + a, content: '这是正文简介' + a });
        }
      }, 800);
    },
    onloading: function onloading(event) {
      ...
      this.show = true;
      setTimeout(function () {
        var length = _this2.newsList.length;
        for (var i = length; i < length + 4; i++) {
          var a = i + 1;
          _this2.newsList.push({ title: 'news' + a, content: '这是正文简介' + a });
        }
    ...
    onrefresh: function onrefresh(event) {
      ...
      setTimeout(function () {
        ...
        for (var i = 0; i < 8; i++) {
          var a = i + 1;
          _this3.newsList.push({ title: 'news' + a, content: '这是正文简介' + a });
        }
    ...
    onpullingdown: function onpullingdown(event) {
      modal.toast({ message: "pulling down", duration: 2 });
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("refresh...")])]), _vm._l((_vm.newsList), function(item) {
    return _c('cell', {
      appendAsTree: true,
      attrs: {
        "append": "tree"
...
exports.default = {
  ...
  methods: {
    ...
    wxcButtonClicked: function wxcButtonClicked(e) {
      modal.toast({ message: '这是按钮1', duration: 2 });
    }
  }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('homepageheader'), _c('homepagemiddle')], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
...
exports.default = {
  components: { Title: _title2.default, Category: _category2.default, WxcRichText: _weexUi.WxcRichText, WxcSpecialRichText: _weexUi.WxcSpecialRichText },
  data: function data() {
    return {
      msg: '一旦它编译完成后，将会自动打开一个浏览器，你可以将浏览器切换到开发者模式，这时候在 console 中你可以看到一个预览二维码，直接使用你的 Weex App 扫码就可以看到 Demo 效果。',
      content: "",
      configTitleString: [{
        type: 'text',
        value: '帖子主题',
  ...
  methods: {
    ...
    add: function add() {
      for (var i = 0; i < 100; i++) {
        this.content = this.content + this.msg;
      }
    }
  }
}; //
...
__vue_options__.__file = "E:\\weexproject\\weex05\\src\\weex_ui\\title.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-39b682f8"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
__vue_options__.__file = "E:\\weexproject\\weex05\\src\\weex_ui\\category.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-1dc7898e"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _Found = __webpack_require__(281);
...
exports.default = {
  ...
  name: 'App',
  components: { Found: _Found2.default },
  methods: {},
  data: function data() {
    return {};
  }
