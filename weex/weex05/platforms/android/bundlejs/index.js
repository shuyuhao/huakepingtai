...
var _PutTextNext = __webpack_require__(294);
...
var router = exports.router = new _vueRouter2.default({
            ...
            routes: [{
                        ...
                        components: { homepage: _Weextext2.default,
                                    notice: _Weextext2.default,
                                    news: _putText2.default,
                                    user: _User2.default
                        }
                        ...
                        path: '/register',
                        components: { user: _register2.default }
...
var _vueevent = __webpack_require__(2);
...
var _setNav = __webpack_require__(19);
  ...
  methods: {
    ...
    getRange: function getRange() {
      ...
      this.$refs.range.getSelectionRange(function (params) {
        _this.state = '\u5F53\u524D\u6587\u672C\u9009\u533A\u4E3A ' + params.selectionStart + ' ~ ' + params.selectionEnd;
        _this.keyboard_state = "";
      });
    }
  }
}; //
...
var _Textarea = __webpack_require__(289);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  })]), _c('text', [_vm._v(_vm._s(_vm.titleValue))]), _c('text', [_vm._v(_vm._s(_vm.textValue))])])
},staticRenderFns: []}
module.exports.render._withStripped = true
    ...
    data: function data() {
        return {
            ...
            list: [{
                ...
                yonghu: 1,
                news: '萨拉看得见我前两次萨拉看得见我前两次萨拉看得见我前两次萨拉看得见我前两次萨拉看得见我前两次萨拉看得见我前两次萨拉看得见我前两次萨拉看得见我前两次'
            }, {
                yonghu: 2,
                news: '萨拉看得见我前两次'
            }, {
                ...
                yonghu: 2,
                news: '萨拉看得见我前萨拉看得见我前两次萨拉看得见我前两次萨拉看得见我前两次萨拉看得见我前两次萨拉看得见我前两次萨拉看得见我前两次'
            }, {
                yonghu: 2,
                news: '萨拉看得见两次'
            }, {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
    ...
    return _c('cell', {
      ...
      staticClass: ["newstext"]
    }, [_vm._v(_vm._s(item.news))])])]) : _vm._e(), (item.yonghu == 2) ? _c('div', {
      ...
      staticClass: ["newstext"]
    }, [_vm._v(_vm._s(item.news))])])]) : _vm._e()])
  })), _c('div', {
    staticClass: ["footer"]
  }, [_c('div', [_c('input', {
    ref: "range",
...
var _urlconfig = __webpack_require__(304);
...
module.exports = {
    ...
    methods: {
        ...
        register: function register() {
            ...
            stream.fetch({
                method: 'POST',
                url: _urlconfig.IP + ':8989/register',
                body: _this.toParams({
...
var IP = exports.IP = 'http://10.12.24.68';
...
exports.default = {
  ...
  created: function created() {
    ...
    _vueevent2.default.$on('toNews', function (data) {
      if (data == 'show') {
        _this.tabStyles = _Config2.default.tabStyles;
        _this.contentStyle = { height: tabPageHeight - _this.tabStyles.height };
      } else {
        _this.tabStyles = _Config2.default.tabStyles_hide;
        _this.contentStyle = { height: tabPageHeight - _this.tabStyles.height };
      }
    });
  }
